//I haven't tested this on the actual system just on a lone arduino and the keypad so it might now work
//turned off serial to save memory
...
// ---------- Graph / B-scan ----------
#define GRAPH_SAMPLES 64   // width of OLED -- may not need to be reduced
...
if (alarm_on) {
  alarm();
  return; // prevent normal beep/sound logic running simultaneously
}
